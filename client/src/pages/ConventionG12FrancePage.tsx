      ...
      {(youtubeVideoId || facebookVideoUrl || liveEnabled) && (
        ...
        <section className="container pb-8 px-4 sm:px-0 mt-8">
          <div className="max-w-4xl mx-auto">
            ...
            {facebookVideoUrl && (
              (() => {
                // Facebook Reels (and some live videos) cannot be embedded via the
                // standard video plugin. Detect them and show a preview card instead.
                const isReel = /facebook\.com\/reel\//i.test(facebookVideoUrl);
                const isUnsupported = isReel; // extend here if other patterns fail
                ...
                // Standard embeddable Facebook video
                return (
